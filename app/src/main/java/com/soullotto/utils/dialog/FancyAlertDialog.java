package com.soullotto.utils.dialog;
...
public class FancyAlertDialog {
    ...
    public static class Builder{
        private String title,message,message2,positiveBtnText,negativeBtnText;
        private int negativeBtnVisibility = View.VISIBLE;
        private Activity activity;
        private int icon;
        private Icon visibility;
        private Animation animation;
        ...
        public Builder setNegativeBtnVisibility(int visibility) {
            this.negativeBtnVisibility = visibility;
            return this;
        }
        ...
        public FancyAlertDialog build(){
            TextView message1, message2, title1;
            ImageView iconImg;
            Button nBtn,pBtn;
            View view;
            final Dialog dialog;
            ...
            message2=(TextView)dialog.findViewById(R.id.message2);
            ...
            message1.setText(Builder.this.message);
            message2.setText(Builder.this.message2);
            ...
            nBtn.setVisibility(negativeBtnVisibility);
